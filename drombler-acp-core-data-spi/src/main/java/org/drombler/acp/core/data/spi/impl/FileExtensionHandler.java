...
public class FileExtensionHandler {
    ...
    protected void bindFileExtensionDescriptor(FileExtensionDescriptor fileExtensionDescriptor) {
        resolveFileExtensionDescriptor(fileExtensionDescriptor);
    }
    ...
    private void resolveFileExtensionDescriptor(FileExtensionDescriptor fileExtensionDescriptor) {
        if (isInitialized()) {
    ...
    private void resolveUnresolvedFileExtensionDescriptors() {
        unresolvedFileExtensionDescriptors.forEach(this::resolveFileExtensionDescriptor);
    }
